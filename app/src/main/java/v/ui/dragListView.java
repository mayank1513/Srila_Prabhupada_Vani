        ...
        if (mDragListener != null || mDropListener != null) {
            switch (ev.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    FrameLayout item = (FrameLayout) getChildAt(itemnum - getFirstVisiblePosition());
        ...
        if ((mDragListener != null || mDropListener != null) && mDragView != null) {
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_CANCEL:
                    ...
                    mDragView.getDrawingRect(r);
                    stopDragging();
                    if (mRemoveMode == SLIDE && ev.getX() > r.right * 3 / 4f) {
...
//        v.setBackgroundResource(R.drawable.ic_reorder_black_24dp);
